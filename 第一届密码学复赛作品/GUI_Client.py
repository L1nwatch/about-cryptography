...
class Client:
    ...
    def _send_file(self):
        ...
        encrypted_aes_key = __encrypt_aes_key(self.server_rsa_pk)
        __exchange_encrypted_aes_key(self.sock)
    ...
    def _receive_file(self):
        ...
        self.encrypted_aes_key = __exchange_encrypted_aes_key(self.sock)
